...
# Type: QssColor
c.colors.completion.even.bg = '#262f33'

# Text color of the completion widget. May be a single color to use for
# all columns or a list of three colors, one for each column.
# Type: List of QtColor, or QtColor
c.colors.completion.fg = '#a0b6b3'

# Background color of the selected completion item.
# Type: QssColor
c.colors.completion.item.selected.bg = '#4f4b58'

# Bottom border color of the selected completion item.
# Type: QssColor
c.colors.completion.item.selected.border.bottom = '#464c50'

# Top border color of the completion widget category headers.
# Type: QssColor
c.colors.completion.item.selected.border.top = '#464c50'

# Foreground color of the selected completion item.
# Type: QtColor
c.colors.completion.item.selected.fg = '#cbcbb7'

# Foreground color of the matched text in the completion.
# Type: QssColor
c.colors.completion.match.fg = '#804f4e'

# Background color of the completion widget for odd rows.
# Type: QssColor
c.colors.completion.odd.bg = '#262f33'
...
# Type: QtColor
c.colors.downloads.start.bg = '#47575f'

# Color gradient start for download text.
# Type: QtColor
c.colors.downloads.start.fg = '#cbcbb7'
...
# Type: QtColor
c.colors.tabs.even.bg = '#262f33'

# Foreground color of unselected even tabs.
# Type: QtColor
c.colors.tabs.even.fg = '#a0b6b3'
...
# Type: QtColor
c.colors.tabs.odd.bg = '#262f33'

# Foreground color of unselected odd tabs.
# Type: QtColor
c.colors.tabs.odd.fg = '#a0b6b3'

# Background color of selected even tabs.
# Type: QtColor
c.colors.tabs.selected.even.bg = '#262f33'

# Foreground color of selected even tabs.
# Type: QtColor
c.colors.tabs.selected.even.fg = '#a0b6b3'

# Background color of selected odd tabs.
# Type: QtColor
c.colors.tabs.selected.odd.bg = '#262f33'

# Foreground color of selected odd tabs.
# Type: QtColor
c.colors.tabs.selected.odd.fg = '#a0b6b3'
...
# Type: QtFont
c.fonts.tabs = '10pt xos4 Terminus'
